-- EverBond clean premium character library reset.
-- Run this in a NEW Supabase SQL query before importing the new raw premium characters.
-- This intentionally removes old character data and all character-dependent pre-launch/test data.
...
grant select, insert, update, delete on public.ever_memory to service_role;
grant select, insert, update, delete on public.relationship_states to service_role;
grant select, insert, update, delete on public.favorites to service_role;
grant select, insert, update, delete on public.character_reports to service_role;
grant select, insert, update, delete on public.image_unlocks to service_role;
